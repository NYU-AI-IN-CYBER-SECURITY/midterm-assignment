...
Midterm Assignment Guide and Submission Instructions

---

## Your Assignment at a Glance

Your job in this project is four things, in this order:
...
- [2. Why Liquid AI's LFM2.5 Model?](#2-why-liquid-ais-lfm25-model)

**[Part II: Environment Setup](#part-ii-environment-setup)**
- [3. Environment Setup and Unsloth Studio Installation](#3-environment-setup-and-unsloth-studio-installation)
  - [A. Download Unsloth Studio Desktop](#a-download-unsloth-studio-desktop)
  - [B. Hardware Compatibility](#b-hardware-compatibility)
  - [C. Cloud Fallback: Jupyter Notebook and Google Colab](#c-cloud-fallback-jupyter-notebook-and-google-colab)

**[Part III: Your Tasks](#part-iii-your-tasks)**
- [Task 1: Build Your Training Dataset and Design Your Prompt (prompter.py)](#task-1-build-your-training-dataset-and-design-your-prompt-prompterpy)
  - [1.1 The Dataset: UNSW-NB15](#11-the-dataset-unsw-nb15)
...
* **Privacy and Local Auditing:** Streaming packet data can be processed entirely locally on-device without exposing sensitive network logs to external cloud APIs or third-party servers.
...
## 3. Environment Setup and Unsloth Studio Installation
...
## Task 1: Build Your Training Dataset and Design Your Prompt (`prompter.py`)

> **Deliverable:** `prompter.py`, plus the formatted training dataset you will load into Unsloth Studio in Task 2.
...
### 1.3 Crucial: Strict JSON Output Format
...
## Task 2: Fine-Tune the Model in Unsloth Studio

> **Deliverable:** `<NYUID>.gguf`, a fully merged GGUF export of your fine-tuned model.
...
### 3.2 The "All Normal" Majority Blindness
...
> **Deliverable:** All three files, uploaded together to the course submission portal.
...
# Part IV: Grading and Benchmarking
...
* You will receive your benchmarking score **the following day**. You can then choose to:
  * **Keep your score** by uploading the provided token to Gradescope (together with your writeup), or
...
## Extra Credit for Fewer Submissions
...
**Important:** If you use all 5 submissions, you forfeit the full **10 points of extra credit available on the midterm project**.
